...
sub$plot_no<- as.factor(sub$plot_no)
...
##########################################################
#  Trait with multiple dates and a trait with one date  #
##########################################################
#select which traits
...
mod<- asreml(fixed= phenotype_value~1+trait_id+at(trait_id, c('GRYLD', 'G-NDVIVeg')):rep, 
               random= ~us(trait_id):gid+
               at(trait_id, 'G-NDVIGF'):phenotype_date+
               at(trait_id, 'G-NDVIGF'):gid:phenotype_date+
               at(trait_id, 'G-NDVIGF'):rep:phenotype_date+ 
               at(trait_id, 'G-NDVIGF'):block:rep:phenotype_date+
               at(trait_id, c('GRYLD', 'G-NDVIVeg')):block:rep,
...
mod<- asreml(fixed= phenotype_value~1+trait_id+at(trait_id, c('GRYLD', 'G-NDVIVeg')):rep+
               at(trait_id):gid, 
             random= ~at(trait_id, 'G-NDVIGF'):phenotype_date+
               at(trait_id, 'G-NDVIGF'):gid:phenotype_date+
               at(trait_id, 'G-NDVIGF'):rep:phenotype_date+ 
               at(trait_id, 'G-NDVIGF'):block:rep:phenotype_date+
               at(trait_id, c('GRYLD', 'G-NDVIVeg')):block:rep,
...
blues<- data.frame(trial='EYTBWBHT_01', blues)

#write the results to a file
write.csv(blues, file= "multiTrait.EYTBWBHT_01.blues.csv")
