...
#look at the fisrt six rows of the data
head(dat)
...
blues<- data.frame(trait='GRYLD', trial='EYTBWB5IR_01', blues)

#write the results to a csv file
#we will use this later on
write.csv(blues, file='gryld.EYTBWB5IR_01.blues.csv')
...
#add metadata to the BLUEs data.frame
blues<- data.frame(trait='NDVIveg', trial='EYTBWB5IR_01', blues)

#write the results to a csv file
#we will use this later on
write.csv(blues, file='NDVIveg.EYTBWB5IR_01.blues.csv')
...
#add metadata to the BLUEs data.frame
blues<- data.frame(trait='NDVIgf', trial='EYTBWB5IR_01', blues)

#write the results to a csv file
#we will use this later on
write.csv(blues, file='NDVIgf.EYTBWB5IR_01.blues.csv')
